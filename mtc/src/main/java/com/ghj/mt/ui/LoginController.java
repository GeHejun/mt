...
import com.ghj.mt.util.ResizeHelper;
...
public class LoginController implements Initializable {
    ...
    public void showScene() {
        Platform.runLater(() -> {
            ...
            con.setUserName(Integer.parseInt(usernameTextfield.getText()));

            MessageManager.getInstance().putMessage(Message.builder().msgType(MessageType.LOGIN)
                    .clientID(Integer.parseInt(usernameTextfield.getText())).build());
        });
    }
